...
This function provides the capability to capture full, point-in-time copies of entire logical volumes or data sets. You can also restore your virtual server in case a critical failure occurs. For instructions, see [Snapshots, cloning, and restoring](/docs/power-iaas?topic=power-iaas-snapshots-cloning)
