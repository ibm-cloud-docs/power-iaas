...
For a complete tutorial on backing up and restoring AIX VM data, see [Backing up and restoring data in an AIX VM](https://ibm.box.com/s/328nt1tt0ez3act1xya9awvphvenoxjm){: new_window}{: external}.
...
For a complete tutorial on backing up and restoring IBM i VM data, see [Backing up and restoring data in an IBM i VM](https://ibm.box.com/s/soq6dpbejq1b272wt538ee0carxda2tv){: new_window}{: external}.
