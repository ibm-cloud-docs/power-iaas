...
{{site.data.keyword.powerSysShort}} provides GRE tunneling to customers in the *Frankfurt 4 and Frankfurt 5* (FRA04 and FRA05) locations. Customers can optionally request a GRE tunnel configuration by adding the request to their {{site.data.keyword.powerSys_notm}} support case.
