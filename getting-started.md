...
If you are creating or configuring a {{site.date.keyword.powerSys_notm}} instance to support an SAP NetWeaver workload, see [Setting up your Power System Virtual Server instances](/docs/sap-netweaver-power?topic=sap-netweaver-power-set-up-power-infrastructure) in the SAP NetWeaver on IBM Power System Virtual Servers documentation. If you are creating or configuring a {{site.date.keyword.powerSys_notm}} instance to support an SAP HANA workload, See [Setting up your Power System Virtual Server instances](/docs/sap-hana-power?topic=sap-hana-power-provision_environment) in the SAP HANA on IBM Power Systems Virtual Servers documentation.
