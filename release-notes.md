...
- Flexible IOPS is now available in the `FRA05` and `MAD04` data centers. For more information, see [Flexible IOPS](/docs/power-iaas?topic=power-iaas-about-virtual-server#storage-tiers).
