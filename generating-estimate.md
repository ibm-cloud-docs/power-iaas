...
Before you deploy a {{site.data.keyword.powerSys_notm}} instance with SAP workloads, create an estimate of the instance with SAP workloads. To learn about the fields and the actions, see the following table.
