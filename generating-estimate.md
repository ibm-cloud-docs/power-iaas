...
9. In the **Save Estimate** panel, select **Create New**.
...
12. Click **Save estimate**. You are redirected to the Estimate panel.
...
| Machine type          | Select a Power10 or later system from the list.                                                                                  |
