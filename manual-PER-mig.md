...
2.	Select **{{site.data.keyword.powerSys_notm}}**under **Topic** and **Power VS Network Related** under **Subtopic**.
...
6.	Upon successful testing, for example, through a ping test, [delete the Direct Link connections](https://cloud.ibm.com/docs/dl?topic=dl-delete-direct-link&interface=ui){: external} and notify IBM by updating the ticket.
