...
When you send API requests to the metadata service, the service triggers events that you can use for auditing. For more information about activity tracker events generated by the Metadata and Identity API, see [Activity Tracker events](/docs/apis/power-cloud-metadata-identity#pvs-at-events){: external}.
