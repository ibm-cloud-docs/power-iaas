...
### Connecting multiple workspaces within a data center
{: #per-same-dc}

To connect multiple workspaces within a data center, enable Power Edge Routers using Transit Gateway. For example, to connect two workspaces within a data center, enable two Power Edege Routers.




![Connecting multiple workspaces within a data center.](./pvs-nw-arch-dia/power-arch-per-workspaces.svg
 "Connecting multiple workspaces within a data center."){: caption="Figure xx. Connecting multiple workspaces within a data center." caption-side="bottom"}


### Connecting multiple workspaces across data centers
{: #per-accross-dc}
...
![Connecting multiple workspaces present in different regions.](./pvs-nw-arch-dia/power-arch-PER-regions.svg
 "Connecting multiple workspaces present in different regions."){: caption="Figure xx. Connecting multiple workspaces present in different regions." caption-side="bottom"}
