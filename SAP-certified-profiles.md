...
For more information about SAP Application Performance Standard (SAPS) and advanced SAPS (aSAPS), see [SAPS/aSAPS](https://www.sap.com/about/benchmark/sizing/decision-tree.html#saps){: external}.
