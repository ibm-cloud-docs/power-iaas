...
The PER solution is available in `DAL10`, `WDC06`, `MAD02`, `MAD04`, and `SAO04` data centers. `MAD02` and `MAD04` are Power10 data center. PER will be deployed in other data centers over time.
{: note}
