...
The PER solution is available in `DAL10`, `WDC06`, `WDCO7`, `MAD02`, `MAD04`, and `SAO04` data centers. `MAD02`, `MAD04`, and `WDCO7` are Power10 data center. PER will be deployed in other data centers over time.
{: note}
