...
The PER solution is available in `DAL10`, `DAL12`, `FRA04`, `FRA05`, `WDC06`, `WDCO7`, `MAD02`, `MAD04`, `OSA21`, `SAO01`, `SAO04`, and `TOK04` data centers. `DAL10`, `MAD02`, `MAD04`, and `WDCO7` are Power10 data center. PER will be deployed in other data centers over time.
{: note}
