...
- API for image import - [Create a new image from available images that are stored in IBM COS](/apidocs/power-cloud#pcloud-v1-cloudinstances-cosimages-post){: external}.
...
To import a boot image, you can use the APIs listed in the [Create a new image from available images that are stored in IBM COS](/apidocs/power-cloud#pcloud-v1-cloudinstances-cosimages-post){: external} topic.
