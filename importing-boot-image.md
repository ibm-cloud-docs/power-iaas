...
The new {{site.data.keyword.powerSysFull}} VM Capture, Image Export, and Image Import features are restricted to one operation at a time per {{site.data.keyword.powerSysFull}} Instance. You can use the {{site.data.keyword.powerSysFull}} legacy REST APIs for Image Import until 1 October 2022. You must plan to transition to the new {{site.data.keyword.powerSysFull}} REST APIs or CLI commands within the sunset period.
{: note}
