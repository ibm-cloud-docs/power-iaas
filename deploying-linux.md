...
The `create_ova` RPM also contains the `create_ova` man page and license. You must install the RPM on VIOS. The `create_ova` command is supported on AIX 7.2 Technology level 5, or later, and VIOS 3.1.2.0, or later.
{: note}
