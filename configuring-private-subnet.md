...
The configuration of the private network subnet depends on the networking configuration of the {{site.data.keyword.powerSys_notm}} workspace, which can use one of the following four approaches:
