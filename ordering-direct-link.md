...
9. When your Direct Link connection request is complete, access the connection information from the Direct Link dashboard. You will need the following network information.
...
10. create a [new support case](/docs/power-iaas?topic=power-iaas-getting-help-and-support) against the {{site.data.keyword.powerSys_notm}} team. In the new case's description field, enter the following details.
