...
3. In the **VMs in placement groups** section, you can [create a new VM](/docs/allowlist/power-iaas?topic=power-iaas-creating-power-virtual-server) and add it to the placement group. You can also add an existing VM to the placement group.
