...
To know more about the SLES versions that are supported, see [What versions of AIX, IBM i, and Linux are supported?](/docs/allowlist/power-iaas?topic=power-iaas-powervs-faqs#os-versions).
...
* [Configuring a data plane network](/docs/allowlist/power-iaas?topic=power-iaas-full-linux-sub#config-dpn)
* [Creating a proxy](/docs/allowlist/power-iaas?topic=power-iaas-full-linux-sub#create-proxy-private)
* [Install squid base](/docs/allowlist/power-iaas?topic=power-iaas-full-linux-sub#squid-base)
* [Completing the setup](/docs/allowlist/power-iaas?topic=power-iaas-full-linux-sub#complete-setup)
