...
NICs are assigned based on the order in which you specify them during provisioning. To display information about all of the network interfaces in the system, open the AIX console and type `ifconfig -a`.
