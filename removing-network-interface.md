...
```
/usr/sbin/mktcpip -h power-systems-virtual-instance -a 192.168.103.12 -m 255.255.255.240 -i en0 -t N/A -g 192.168.103.1 -n 127.0.0.1 -d aus.stglabs.ibm.com -D 0.0.0.0
```
{: codeblock}
