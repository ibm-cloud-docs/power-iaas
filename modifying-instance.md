...
Learn how to add new storage volumes and modify existing ones. Currently, you cannot mix **Tier 1** and **Tier 3** storage types in the **us-south (DAL13)**, **eu-de (FRA04 and FRA05)**, **eu-gb (LON06)** and **us-east (TOR01-only)** regions.
