...
The copy-and-paste functionality of the VSI console enables bidirectional text transfer between Windows&reg;, macOS&reg;, and Linux-based workstations, and AIX, IBM i, and Linux-based VSI consoles. You can copy text, such as commands and large scripts, and paste the copied text into the VSI console. You can also copy logs or error messages from the console and paste them into your workstation for troubleshooting or creating support tickets.
