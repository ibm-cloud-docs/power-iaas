...
3. In the **Resource details** section, complete the following:
   ...
   {{site.data.keyword.tg_full_notm}} is currently available in `WDC04`, `DAL12`, `LON04`, `LON06`, `FRA04`, `FRA05`, `SAO01`, `SYD04`, `TOK04`, `TOR01`, and `MON01` data centers.
   
   You must select Transit Gateway as the network connection type instead of Direct resources while creating Direct Link 2.0 Connect to use IBM Cloud Transit Gateway in WDC06.
   {: note}
