...
If you are creating a new service, you automatically receives two up to 10 Gbps Cloud connections at no cost. After the first two connections, charges apply based on speed and number of connections that you choose to have.
{: note}
...
You can configure a private network subnet when you create an IBM Power Systems Virtual Server instance. You must use CIDR notation when you choose the IP ranges for your private network subnet. CIDR notation is defined in [RFC 1518](https://tools.ietf.org/html/rfc1518) and [RFC 1519](https://tools.ietf.org/html/rfc1519).
...
Following is the GRE tunnel configuration that you must follow in your VRA:
