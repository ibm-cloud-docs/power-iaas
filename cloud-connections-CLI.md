...
3. In the **Resource details** section, complete the following:
   ...
   {{site.data.keyword.tg_full_notm}} is currently available in `WDC04`, `DAL10`, `DAL12`, `DAL13`, `LON04`, `LON06`, `FRA04`, `FRA05`, `SAO01`, `SYD04`, `TOK04`, `TOR01`, `MON01`, `SYD05`, and `OSA21` data centers.
